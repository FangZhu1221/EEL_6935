...
from keras.layers import Dense, Dropout, Activation, Conv1D, MaxPooling1D, Flatten, Embedding
...
model.add(Conv1D(512, kernel_size=3, strides=1, activation='relu', input_shape=(14, 256)))
